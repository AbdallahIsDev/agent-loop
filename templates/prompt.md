...
5. When done: update todo.md (mark complete), append to done.md, update status.md
6. If more items remain in todo.md, continue with the next one
7. When todo is empty, review your work and summarize in status.md
